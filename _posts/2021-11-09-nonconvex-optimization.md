...
<div id="proxsarah" style="display:none;">For fixed step-size \(\gamma=1/L\sqrt{\omega M}\) and \(\rho=2\sqrt{\omega M}/(4\sqrt{\omega M}+1)\), where \(\omega=3(n-\hat{b})/(2\hat{b}(n-1)\) for some \(b\in[1,\sqrt{n}]\), then
