import{d as p,_ as u,y as h,b as a,e as t,x as s,A as r,F as f,Z as v,o as n,$ as g,l as x,g as b}from"../modules/vue-DnkrJioT.js";import{e as y,h as N,c as m,b as k}from"../index-OhIvRzYI.js";import{N as w}from"./NoteDisplay-Bazn3N0h.js";import"../modules/shiki-DQpr8KuN.js";const D={id:"page-root"},H={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},B={class:"text-lg"},S={class:"font-bold flex gap-2"},j={class:"opacity-50"},A=t("div",{class:"flex-auto"},null,-1),C={key:0,class:"border-main mb-8"},F=p({__name:"print",setup(M){const{slides:_,total:d}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
